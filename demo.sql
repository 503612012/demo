...
INSERT INTO `t_config_dev` VALUES (6, 'spring.datasource.type', 'com.alibaba.druid.pool.DruidDataSource', NULL);
INSERT INTO `t_config_dev` VALUES (7, 'spring.datasource.initialSize', '20', NULL);
INSERT INTO `t_config_dev` VALUES (8, 'spring.datasource.minIdle', '10', NULL);
INSERT INTO `t_config_dev` VALUES (9, 'spring.datasource.maxActive', '100', NULL);
...
INSERT INTO `t_config_dev` VALUES (31, 'info.head', 'head', NULL);
INSERT INTO `t_config_dev` VALUES (32, 'info.body', 'body', NULL);
INSERT INTO `t_config_dev` VALUES (33, 'management.endpoints.web.exposure.include', '\'*\'', NULL);
INSERT INTO `t_config_dev` VALUES (34, 'management.endpoint.health.show-details', 'always', NULL);
INSERT INTO `t_config_dev` VALUES (35, 'management.endpoint.health.shutdown.enabled', 'false', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_crontab` VALUES (1, 'cronKey', 'cron的key', '0/27 * * * * ?');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='员工表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1369 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='日志表';
...
) ENGINE=InnoDB AUTO_INCREMENT=667 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='菜单表';
...
INSERT INTO `t_menu` VALUES (25, 'B1_02', '工时管理', 18, 2, '/workhour/index', '', 1, NULL, '2018-08-21 18:15:27', 1, '2018-11-01 14:45:14', 0);
...
INSERT INTO `t_menu` VALUES (29, 'B1_03', '工地管理', 18, 3, '/worksite/index', '', 1, NULL, '2018-08-21 18:15:27', 1, '2018-11-01 14:45:08', 0);
...
INSERT INTO `t_menu` VALUES (39, 'C1_03', '工资统计', 34, 3, NULL, '', 1, NULL, '2018-08-21 18:15:27', 1, '2019-09-25 17:36:20', 0);
INSERT INTO `t_menu` VALUES (40, 'D1', '工具集成', 0, 3, NULL, 'layui-icon-util', 1, NULL, '2018-08-21 18:15:27', 1, '2019-09-25 17:29:42', 1);
INSERT INTO `t_menu` VALUES (41, 'D1_01', 'Echarts集成', 40, 1, '/tools/echarts/index', '', 1, NULL, '2018-08-21 18:15:27', 1, '2019-01-10 20:28:56', 0);
COMMIT;
...
CREATE TABLE `t_pay_record` (
  ...
  `remark` text,
  PRIMARY KEY (`dbid`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='发薪记录表';
...
INSERT INTO `t_role` VALUES (17, '普通用户', '2018-10-26 01:15:48', 1, 0, '2018-10-31 09:25:19', 1);
INSERT INTO `t_role` VALUES (19, '管理员', '2019-05-14 15:10:11', 1, 0, '2019-05-14 15:10:11', 1);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=1932 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='角色-菜单关系表';

-- ----------------------------
-- Records of t_role_menu
-- ----------------------------
BEGIN;
INSERT INTO `t_role_menu` VALUES (1894, 1, 18);
INSERT INTO `t_role_menu` VALUES (1895, 1, 19);
INSERT INTO `t_role_menu` VALUES (1896, 1, 20);
INSERT INTO `t_role_menu` VALUES (1897, 1, 21);
INSERT INTO `t_role_menu` VALUES (1898, 1, 22);
INSERT INTO `t_role_menu` VALUES (1899, 1, 23);
INSERT INTO `t_role_menu` VALUES (1900, 1, 24);
INSERT INTO `t_role_menu` VALUES (1901, 1, 25);
INSERT INTO `t_role_menu` VALUES (1902, 1, 26);
INSERT INTO `t_role_menu` VALUES (1903, 1, 27);
INSERT INTO `t_role_menu` VALUES (1904, 1, 29);
INSERT INTO `t_role_menu` VALUES (1905, 1, 30);
INSERT INTO `t_role_menu` VALUES (1906, 1, 31);
INSERT INTO `t_role_menu` VALUES (1907, 1, 32);
INSERT INTO `t_role_menu` VALUES (1908, 1, 33);
INSERT INTO `t_role_menu` VALUES (1909, 1, 34);
INSERT INTO `t_role_menu` VALUES (1910, 1, 35);
INSERT INTO `t_role_menu` VALUES (1911, 1, 36);
INSERT INTO `t_role_menu` VALUES (1912, 1, 37);
INSERT INTO `t_role_menu` VALUES (1913, 1, 38);
INSERT INTO `t_role_menu` VALUES (1914, 1, 39);
INSERT INTO `t_role_menu` VALUES (1915, 1, 1);
INSERT INTO `t_role_menu` VALUES (1916, 1, 2);
INSERT INTO `t_role_menu` VALUES (1917, 1, 3);
INSERT INTO `t_role_menu` VALUES (1918, 1, 4);
INSERT INTO `t_role_menu` VALUES (1919, 1, 5);
INSERT INTO `t_role_menu` VALUES (1920, 1, 6);
INSERT INTO `t_role_menu` VALUES (1921, 1, 7);
INSERT INTO `t_role_menu` VALUES (1922, 1, 11);
INSERT INTO `t_role_menu` VALUES (1923, 1, 12);
INSERT INTO `t_role_menu` VALUES (1924, 1, 13);
INSERT INTO `t_role_menu` VALUES (1925, 1, 14);
INSERT INTO `t_role_menu` VALUES (1926, 1, 15);
INSERT INTO `t_role_menu` VALUES (1927, 1, 16);
INSERT INTO `t_role_menu` VALUES (1928, 1, 8);
INSERT INTO `t_role_menu` VALUES (1929, 1, 9);
INSERT INTO `t_role_menu` VALUES (1930, 1, 10);
INSERT INTO `t_role_menu` VALUES (1931, 1, 17);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_user` VALUES (1, 'Oven', '96ba8efe664c1b11fa56a691e1094cc8', 'Oven', 18, 'oven@cloveaire.com', '15712341234', 0, 1, '2018-10-19 12:52:17', 1, '2018-10-29 20:32:18', 1);
INSERT INTO `t_user` VALUES (8, 'admin', 'd8e6ca2238dccaf93c13bde915f9e88f', 'admin', 18, 'admin@cloveaire.com', '15712341234', 0, 1, '2018-10-30 09:49:43', 1, '2019-06-14 11:11:46', 1);
COMMIT;
