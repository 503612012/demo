            ...
            {field: 'lastLoginTime', width: 180, title: '最后登录时间'},
            {
                field: 'status', width: 110, title: '状态', templet: function(d) {
                    if (d.status == 1) {
                        ...
                        return '<div><div class="layui-unselect layui-form-checkbox user-status" data-id="' + d.id + '" data-status="' + d.status + '"><span>正常</span><i class="layui-icon layui-icon-ok"></i></div></div>';
                    }
                }
            },
