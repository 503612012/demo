            ...
            orderColumn,
            {
                field: 'status', title: '状态', templet: function(d) {
                    if (d.status == 1) {
                        ...
                        return '<div><div class="layui-unselect layui-form-checkbox fund-status" data-id="' + d.id + '" data-status="' + d.status + '"><span>正常</span><i class="layui-icon layui-icon-ok"></i></div></div>';
                    }
                }
            },
