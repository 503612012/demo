layui.define(["form"], function (exports) {
    ...
    tree.prototype.template = function (data) {
        var t = this,
            level = [],
            tbody = "",
            thead = t.c.is_checkbox ? '<td><div><input type="checkbox" lay-skin="primary" lay-filter="lay-t"></div></td>' : '';
        ...
        o.each(data, function (index, item) {
            ...
            o.each(t.c.cols, function (idx, obj) {
                tr += '<td style="width:' + obj.width + '"><div ' + hide_class + ">";
        ...
        o(t.c.elem).html(template).on("click", "td", function () {
            ...
            if (dt.length) {
                if (status) {
                    ...
                    o(t.c.elem).find("tr[data-pid=" + id + "]").slideDown().find("td div").slideDown();
                    t.cache(id, true);
