...
public class BaseDao<T> {
     ...
     * 获取插入语句
     */
    public SqlAndParams getInsertFromObject(T po) throws Exception {
        // 用来存放insert语句
        ...
        for (Field field : fields) {
            ...
            // 获取具体参数值
            Method getter = getGetter(po.getClass(), field);
     ...
     * 获取更新语句
     */
    public SqlAndParams getUpdateSql(Object po) throws Exception {
        // 用来存放update语句
     ...
     * 获取自增主键字段名
     */
    public String getAutoGeneratedId(Object obj) {
     ...
     */
    public AutoGeneratePreparedStatementCreator getAutoGeneratePreparedStatementCreator(String sql, Object[] params, Object obj) {
